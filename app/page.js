    ...
    try {
      ...
      const migrated = parsed
        ...
        .map(d => {
          ...
          // 2026-05-13: shift "Original" semantics from principal financed to
          // total scheduled debt service at inception (matches lender views like
          // Balboa's portal). Only update if the field still matches the prior
          // exact value, so manual edits aren't overwritten.
          if (d.id === 'd3' && out.originalAmount == null) out.originalAmount = 75000;
          if (d.id === 'd5' && out.originalAmount === 2250000) out.originalAmount = 3572040;
          if (d.id === 'd7' && out.originalAmount === 250000) out.originalAmount = 300000;
          if (d.id === 'd11' && out.originalAmount === 483000) out.originalAmount = 716124;
          ...
          if (d.id === 'd14' && out.originalAmount === 140000) out.originalAmount = 174370.80;
          if (d.id === 'd17' && out.originalAmount === 29504.82) out.originalAmount = 38349.00;
