    ...
    try {
      ...
      const migrated = parsed
        ...
        .map(d => {
          ...
          // cleanup flag and reassign to Fish Island (the operating entity
          // that's keeping the vans on the road).
          if (d.id === 'd13') {
            out.cleanup = false;
            out.entity = 'Fish Island';
          }
