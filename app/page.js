...
const DEBT_SEED = [
  ...
  { id: 'd13', lender: 'Ameris (Balboa) - 2x RAM 2500 ProMaster (Veh #3, #4)', entity: 'NEF', debtType: 'Vehicle Loan', cleanup: true, originalAmount: 160000, originationDate: '2026-05-08', maturityDate: '2031-05-08', interestRate: 0.09, termMonths: 60, monthlyPayment: 3321.34, balance: 160000, notes: '2x 2023 RAM 2500 ProMaster (VINs 3C6LRVVG1PE562519, 3C6LRVVG3PE533006). Combined payoff $160,000; expected sale value $120,000; net equity ($40,000).\n\nMODELED for cash-flow purposes only: 5-year amortization at 9.00% APR, monthly P&I $3,321.34. Origination/maturity dates are placeholders (origin 2026-05-08); actual contract terms not yet captured. Replace once original loan docs are in hand.', docFiles: [] },
